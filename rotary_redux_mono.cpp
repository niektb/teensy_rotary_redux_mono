/* ------------------------------------------------------------
name: "rotary_redux_mono"
Code generated with Faust 2.37.3 (https://faust.grame.fr)
Compilation options: -a C:\Program Files\Faust\share\faust/teensy/teensy.cpp -lang cpp -dtl 0 -es 1 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a C:\Program Files\Faust\share\faust/teensy/teensy.cpp -lang cpp -dtl 0 -es 1 -single -ftz 0");
		...
		m->declare("filename", "rotary_redux_mono.dsp");
		...
		m->declare("name", "rotary_redux_mono");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst1 = std::tan((628.318542f / fConst0));
		fConst2 = (1.0f / fConst1);
		float fConst3 = (fConst2 + 1.0f);
		fConst4 = (1.0f / fConst3);
		float fConst5 = std::tan((2513.27417f / fConst0));
		float fConst6 = (1.0f / fConst5);
		float fConst7 = (fConst6 + 1.0f);
		fConst8 = (1.0f / fConst7);
		fConst9 = (1.0f - fConst6);
		fConst10 = (1.0f - fConst2);
		fConst11 = (6283.18555f / fConst0);
		float fConst12 = std::tan(fConst11);
		fConst13 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fConst12))));
		fConst14 = (1.0f / (fConst5 * fConst7));
		fConst15 = (0.0f - fConst14);
		fConst16 = (fConst9 / fConst7);
		fRec5_widx = 0;
		fConst17 = ((0.0299999993f * fConst0) + 1.0f);
		fConst18 = (1.0f / fConst0);
		fConst19 = (44.0999985f / fConst0);
		fConst20 = (1.0f - fConst19);
		fConst21 = (4.0f * fConst0);
		fConst22 = (1.0f / fConst12);
		fConst23 = (15707.9629f / (fConst0 * std::sin((12566.3711f / fConst0))));
		fConst24 = (0.0f - (1.0f / (fConst1 * fConst3)));
		fConst25 = (0.826446295f / fConst0);
		fConst26 = (12.0f * fConst0);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addCheckButton("Chorale/Tremolo", &fCheckbox0);
		ui_interface->declare(&fVslider1, "02", "");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("Gain", &fVslider1, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f), FAUSTFLOAT(10.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->declare(&fVslider0, "03", "");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("Volume", &fVslider0, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fVslider2, "04", "");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("Speed", &fVslider2, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.100000001f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fVslider3, "07", "");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->addVerticalSlider("Horn", &fVslider3, FAUSTFLOAT(5.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(10.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (2.0f * float(fVslider1));
		float fSlow2 = (fConst19 * float(fVslider2));
		float fSlow3 = float(fCheckbox0);
		int iSlow4 = (fSlow3 == 0.0f);
		float fSlow5 = float(fVslider3);
		int iSlow6 = (fSlow5 > 0.0f);
		float fSlow7 = (fConst23 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow5))));
		float fSlow8 = (iSlow6 ? fConst23 : fSlow7);
		float fSlow9 = ((fConst22 * (fConst22 - fSlow8)) + 1.0f);
		float fSlow10 = ((fConst22 * (fConst22 + fSlow8)) + 1.0f);
		float fSlow11 = (iSlow6 ? fSlow7 : fConst23);
		float fSlow12 = ((fConst22 * (fConst22 + fSlow11)) + 1.0f);
		float fSlow13 = ((fConst22 * (fConst22 - fSlow11)) + 1.0f);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			float fTemp0 = float(input0[i0]);
			float fTemp1 = (fRec0[1] + 0.00999999978f);
			float fTemp2 = (fRec0[1] + -0.00999999978f);
			float fThen1 = ((fTemp2 > 0.0f) ? fTemp2 : 0.0f);
			fRec0[0] = ((fTemp1 < 0.0f) ? fTemp1 : fThen1);
			float fTemp3 = (1.0f - fRec0[0]);
			float fTemp4 = std::atan((fSlow1 * (fTemp0 * fTemp3)));
			fVec0[0] = fTemp4;
			fRec2[0] = (fConst8 * ((0.903221011f * (fTemp4 + fVec0[1])) - (fConst9 * fRec2[1])));
			fRec1[0] = (fConst4 * ((fRec2[0] + fRec2[1]) - (fConst10 * fRec1[1])));
			int fRec5_ridx_tmp0 = (fRec5_widx - 1);
			int fRec5_widx_tmp = fRec5_widx;
			fRec5[fRec5_widx_tmp] = ((0.903221011f * ((fConst14 * fTemp4) + (fConst15 * fVec0[1]))) - (fConst16 * fRec5[((fRec5_ridx_tmp0 < 0) ? (fRec5_ridx_tmp0 + 32) : fRec5_ridx_tmp0)]));
			fRec8[0] = (fSlow2 + (fConst20 * fRec8[1]));
			fVec2[0] = fSlow3;
			fRec9[0] = (fSlow3 + (fRec9[1] * float((fVec2[1] >= fSlow3))));
			float fTemp5 = std::max<float>(1.0f, (fConst21 * fRec8[0]));
			iRec10[0] = (iSlow4 * (iRec10[1] + 1));
			float fTemp6 = float(iRec10[0]);
			float fTemp7 = (fRec7[1] + (fConst18 * (fRec8[0] * ((7.0f * std::max<float>(0.0f, (std::min<float>((fRec9[0] / fTemp5), 1.0f) - (fTemp6 / fTemp5)))) + 1.0f))));
			fRec7[0] = (fTemp7 - std::floor(fTemp7));
			float fTemp8 = (ftbl0mydspSIG0[int((65536.0f * fRec7[0]))] + 1.0f);
			float fTemp9 = (15.0f * fTemp8);
			int iTemp10 = int(fTemp9);
			int fRec5_ridx_tmp1 = (fRec5_widx - int(std::min<float>(fConst17, float(std::max<int>(0, iTemp10)))));
			float fTemp11 = std::floor(fTemp9);
			int fRec5_ridx_tmp2 = (fRec5_widx - int(std::min<float>(fConst17, float(std::max<int>(0, (iTemp10 + 1))))));
			float fTemp12 = std::tan((fConst11 * ((1.0f - (0.5f * fTemp8)) + 1.0f)));
			float fTemp13 = (1.0f / fTemp12);
			float fTemp14 = (((fTemp13 + 1.42857146f) / fTemp12) + 1.0f);
			fRec4[0] = ((((fRec5[((fRec5_ridx_tmp1 < 0) ? (fRec5_ridx_tmp1 + 32) : fRec5_ridx_tmp1)] * (fTemp11 + (1.0f - fTemp9))) + ((fTemp9 - fTemp11) * fRec5[((fRec5_ridx_tmp2 < 0) ? (fRec5_ridx_tmp2 + 32) : fRec5_ridx_tmp2)])) * (1.0f - (0.300000012f * fTemp8))) - (((fRec4[2] * (((fTemp13 + -1.42857146f) / fTemp12) + 1.0f)) + (2.0f * (fRec4[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp12)))))) / fTemp14));
			float fTemp15 = (fConst13 * fRec3[1]);
			fRec3[0] = (((fRec4[2] + (fRec4[0] + (2.0f * fRec4[1]))) / fTemp14) - (((fRec3[2] * fSlow9) + fTemp15) / fSlow10));
			fRec11[0] = ((fConst24 * fRec2[1]) - (fConst4 * ((fConst10 * fRec11[1]) - (fConst2 * fRec2[0]))));
			float fTemp16 = std::max<float>(1.0f, (fConst26 * fRec8[0]));
			float fTemp17 = (fRec12[1] + (fConst25 * (fRec8[0] * ((7.0f * std::max<float>(0.0f, (std::min<float>((fRec9[0] / fTemp16), 1.0f) - (fTemp6 / fTemp16)))) + 1.0f))));
			fRec12[0] = (fTemp17 - std::floor(fTemp17));
			output0[i0] = FAUSTFLOAT(((fTemp0 * fRec0[0]) + (fSlow0 * (fTemp3 * ((fRec1[0] + (((fTemp15 + (fRec3[0] * fSlow12)) + (fRec3[2] * fSlow13)) / fSlow10)) - (0.5f * (fRec11[0] * (ftbl0mydspSIG0[int((65536.0f * fRec12[0]))] + 1.0f))))))));
			fRec0[1] = fRec0[0];
			fVec0[1] = fVec0[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec5_widx_tmp = (fRec5_widx_tmp + 1);
			fRec5_widx_tmp = ((fRec5_widx_tmp == 32) ? 0 : fRec5_widx_tmp);
			fRec5_widx = fRec5_widx_tmp;
			fRec8[1] = fRec8[0];
			fVec2[1] = fVec2[0];
			fRec9[1] = fRec9[0];
			iRec10[1] = iRec10[0];
	...
	#define FAUST_FILE_NAME "rotary_redux_mono.dsp"
	...
	FAUST_ADDCHECKBOX("Rotary/Chorale/Tremolo", fCheckbox0);
	FAUST_ADDVERTICALSLIDER("Rotary/Gain", fVslider1, 1.0f, 0.10000000000000001f, 10.0f, 0.10000000000000001f);
	FAUST_ADDVERTICALSLIDER("Rotary/Volume", fVslider0, 1.0f, 0.001f, 2.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("Rotary/Speed", fVslider2, 0.5f, 0.10000000000000001f, 1.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("Rotary/Horn", fVslider3, 5.0f, 0.0f, 10.0f, 0.10000000000000001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(CHECKBOX, Chorale/Tremolo, "Rotary/Chorale/Tremolo", fCheckbox0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(VERTICALSLIDER, Gain, "Rotary/Gain", fVslider1, 1.0f, 0.10000000000000001f, 10.0f, 0.10000000000000001f) \
		p(VERTICALSLIDER, Volume, "Rotary/Volume", fVslider0, 1.0f, 0.001f, 2.0f, 0.01f) \
		p(VERTICALSLIDER, Speed, "Rotary/Speed", fVslider2, 0.5f, 0.10000000000000001f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, Horn, "Rotary/Horn", fVslider3, 5.0f, 0.0f, 10.0f, 0.10000000000000001f) \
...
rotary_redux_mono::rotary_redux_mono() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
rotary_redux_mono::~rotary_redux_mono()
{
    delete fDSP;
    delete fUI;
    for (int i = 0; i < fDSP->getNumInputs(); i++) {
...
void rotary_redux_mono::updateImp(void)
{
#if MIDICTRL
...
void rotary_redux_mono::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void rotary_redux_mono::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float rotary_redux_mono::getParamValue(const std::string& path)
{
